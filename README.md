...
9. It delivers significantly more relevant results by proposing a better architecture that addresses the limitations of embedding based candidate retrieval (that uses ANN search and OpenAI's CLIP model), ranking models etc. It does use embedding models, ANN and ranking algorithms being used by current SOTA search pipelines.
