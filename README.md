...
9. It delivers significantly more relevant results by proposing a better architecture that addresses the limitations of embedding based candidate retrieval (dense retrieval), ranking models etc. It does use embedding models, ANN and ranking algorithms being used by current SOTA search pipelines.

10. It asks the seller multiple product relevant questions when he/she is listing a product onto the platform.
...
<p>
Conventional search engines that rely on dense retrieval and OpenAI's CLIP for candidate retrieval often return irrelevant results because a high embedding similarity score does not necessarily imply high relevance. Two phrases may show a high embedding similarity score simply because they contain synonymous or closely related words. For example, the query “red jacket worn by Michael Jackson in the Thriller music video 1983” may rank “Men's Thriller Style Red Dance Jacket Halloween Costume Replica” highly due to shared terms, even though it isn’t the desired item. The actual desired product—“MJJ Productions Official Retro Leather Outfit MJT-1983 Limited Edition”—might receive a lower similarity score despite being the correct match because embedding models can't reason and search the web like ChatGPT and Gemini. 
</p>
...
LLM Used for Complex Queries Only (30%) = 0.30 × 8.2M = 2.46M queries/day<br>
